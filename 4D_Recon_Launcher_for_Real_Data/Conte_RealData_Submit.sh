...
### SLS Dataset ###
python XT_Main.py --run_setup --run_recon --gen_outfiles --MBIR --ATT --REAL_DATA --num_nodes 1 --Purdue --Path2Data $RCAC_SCRATCH/SLS_Datasets/SLS_Dataset.h5 --Path2WhitesDarks $RCAC_SCRATCH/SLS_Datasets/SLS_Dataset.h5 --Path2Phantom $RCAC_SCRATCH/Sim_Datasets/phantom_Cahn_Hilliard.bin --Path2Mask $RCAC_SCRATCH/Sim_Datasets/phantom_Cahn_Hilliard_mask.bin --run_folder $RCAC_SCRATCH/Recon_Runs/PhCon_Real/ --rot_center 636 --vox_size 0.74 --proj_start 0 --proj_num 1000 --x_width 2560 --recon_x_width 1280 --z_start 0 --z_width 8 --recon_z_width 4 --vox_stop_thresh 2 --cost_stop_thresh 10 --sigma_s 250000 --sigma_t 10000 --K 1 --N_theta 1000 --r 1 --multres_xy 6 --multres_z 1 --do_VarEstimate 0 --MaxIter 1000 --msg_string _Att --min_time_btw_views 0.0 --rotation_speed 108 --ZingerT 4 --maxHU 40000 --minHU 0 --BH_Quad_Coef 0.0
