...
def recon_init (proj):
	...
	recon['delta_xy'] = [16, 8, 4, 2]
	recon['delta_z'] = [4, 2, 2, 2]
	recon['initICD'] = [0, 3, 2, 2]
	recon['writeTiff'] = [1, 1, 1, 1]
	recon['updateProjOffset'] = [0, 1, 2, 2]

	recon['num_threads'] = 16
	#recon['num_threads'] = 1
	recon['p'] = 1.2
	recon['iterations'] = 1000
	recon['alpha'] = 1.5
	recon['time_reg'] = 1
...
def files_init ():
	...
	files['Launch_Folder'] = os.environ['RCAC_SCRATCH'] + "/Recon_Runs/XT_run_2/"
