...
#	proj['Path2WhiteDark'] = files['data_scratch'] + "/Argonne_Datasets/K_16_N_theta_2000_RotSpeed_100_Exp_4_ROI_1000x2080_Ramp_2/k-16-4ms-last_31.hdf"
	...
	files['Result_Folder'] = files['scratch'] + "/Recon_Runs/Al-Cu-Dendrite_1/XT_Result_Repository/" #results will be stored here
	files['Launch_Folder'] = files['scratch'] + "/Recon_Runs/Al-Cu-Dendrite_1/XT_run/" #location where reconstruction will be run
